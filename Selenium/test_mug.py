...
class TestMug():
  ...
  def test_mug(self):
    ...
    self.driver.set_window_size(728, 759)
    ...
    self.driver.find_element(By.NAME, "textField1").send_keys("Selenium")
    self.driver.find_element(By.NAME, "submitCustomizedData").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".customization-message > label").text == "Selenium"
